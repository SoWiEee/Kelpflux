...
- **多重比較與檢力（已處置）：** §5.3.1–5.3.3 每場景同時對 6–8 個臂檢定 score，已於 §5.3.4 補做 **Holm-Bonferroni 跨臂族校正**——校正後僅「score 勝 vanilla Slurm FCFS」穩健，各學習臂與 score 之差異均不再顯著，故本文不主張任何「學習式顯著較差」。同時以 **TOST 對 ±5% 帶檢定等價**、報告 **n=8 的 MDE**（cuBLAS≈4.9%、Hybrid≈12.6%）：cuBLAS 場景多臂證實 ±5% 等價（平坦為證實而非檢力不足），Hybrid 場景則因高變異僅達「不可區分」、尚不足以正面宣稱等價（收窄 CI 需擴至約 n=16–24 seed，未來工作）。
